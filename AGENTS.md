...
### Code Review Summary (Phase 2 complete)

**Исправлено:**
- ✅ 15 clippy warnings → 4 (некритичные)
- ✅ Yield lowering добавлен
- ✅ Index/List/Dict/Set/Dot/Method lowering реализованы
- ✅ 68 тестов проходят

**Оставшиеся warnings (некритично):**
- `next()` method name в lexer
- `default()` method name в sema
- `get_stdlib_path()` unused в cli
